...
func (x *RegisterData) GetConfirmPassword() string {
	if x != nil {
...
func (x *DeleteData) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *DeleteData) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *DeleteData) GetConfirmPassword() string {
	if x != nil {
		return x.ConfirmPassword
	}
	return ""
...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\x1a\x1bgoogle/protobuf/empty.proto\"\x87\x01\n" +
	...
	"\busername\x18\x01 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\"\x85\x01\n" +
	"\n" +
	"DeleteData\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x1a\n" +
	...
	"\x05email\x18\x03 \x01(\tR\x05email2\x9d\x01\n" +
	"\vUserService\x12,\n" +
	"\n" +
	"SignupUser\x12\x12.user.RegisterData\x1a\n" +
	".user.User\x12(\n" +
	"\tLoginUser\x12\x0f.user.LoginData\x1a\n" +
	".user.User\x126\n" +
	"\n" +
	"DeleteUser\x12\x10.user.DeleteData\x1a\x16.google.protobuf.EmptyB\bZ\x06./userb\x06proto3"
...
var file_user_user_proto_goTypes = []any{
	(*RegisterData)(nil),  // 0: user.RegisterData
	(*LoginData)(nil),     // 1: user.LoginData
	(*DeleteData)(nil),    // 2: user.DeleteData
	(*User)(nil),          // 3: user.User
	(*emptypb.Empty)(nil), // 4: google.protobuf.Empty
}
var file_user_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.SignupUser:input_type -> user.RegisterData
	1, // 1: user.UserService.LoginUser:input_type -> user.LoginData
	2, // 2: user.UserService.DeleteUser:input_type -> user.DeleteData
	3, // 3: user.UserService.SignupUser:output_type -> user.User
	3, // 4: user.UserService.LoginUser:output_type -> user.User
	4, // 5: user.UserService.DeleteUser:output_type -> google.protobuf.Empty
